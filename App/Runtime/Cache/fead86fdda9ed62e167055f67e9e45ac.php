...
<head>
    ...
    <!-- BEGIN -->
    <link type="text/css" href="__PUBLIC__/css/oocss.css" rel="stylesheet" />
    <!-- END -->
        ...
        <form action="<?php echo U('setting/fielddelete');?>" method="post" onSubmit="return checkForm()">
            <div class="span10">
                <p><div class="bulk-actions align-left"> 
					...
					<a href="http://5kcrm.com/index.php?m=doc&a=index&id=55" target="_blank" style="font-size: 12px;color: rgb(255, 102, 0);"><img width="20px;" src="__PUBLIC__/img/help.png"/> <?php echo L('HELP');?></a>
