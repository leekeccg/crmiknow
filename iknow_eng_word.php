    ...
    <div class="container">
        ...
        <div class="list">
            <div class="mbl">
                ...
                <a class="btn btn-primary" href="https://iknow.jp/custom/courses/<?php echo $_GET['iknow_id']; ?>#!/" target="_blank">page</a>
                <a class="btn btn-primary" href="https://iknow.jp/courses/<?php echo $_GET['iknow_id']; ?>" target="_blank">course</a>
                <a class="btn btn-primary" href="https://iknow.jp/api/v2/goals/<?php echo $_GET['iknow_id']; ?>/memories?oauth_token=eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWIiOjIwMjY5OTcsImVtYWlsIjoibGVla2UuemhvdUBnbWFpbC5jb20iLCJwaG9uZSI6IiIsImlhdCI6MTUwNDIzODc0NSwiZXhwIjoxNTA0MjQ1OTQ1LCJqdGkiOiI5UzJkQnRYV2ZUZXRYNTNscnByNFhFWk9hMlU9In0.WLvGOqgPsdHDpdnMJLl_xqtlo9mrA7lLmXYdKxeHSZY" target="_blank">memories</a>
        ...
        if($getPage=="word"){$js_file="iknow_eng_word";}
