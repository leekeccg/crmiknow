...
<div class="container"><!-- InstanceBeginEditable name="EditRegion1" -->
  ...
  <table class="table table-bordered table-hover table-striped">
    ...
    <?php do { ?>
      <tr>
        <td><?php echo $row_Recordset1['business_id']; ?></td>
        <td><a target="_blank" href="http://dict.youdao.com/w/<?php echo $row_Recordset1['name']; ?>"><?php echo $row_Recordset1['name']; ?></a></td>
        <!--<td><?php echo $row_Recordset1['item_id']; ?></td>-->
        <td><a href="http://iknow.jp/custom/courses/<?php echo $row_Recordset1['iknow_id']; ?>#!/" target="_blank"><?php echo $row_Recordset1['iknow_id']; ?></a>
        <input type="text" value="http://iknow.jp/custom/courses/<?php echo $row_Recordset1['iknow_id']; ?>#!/" class="form-control"/>
        </td>
      </tr>
